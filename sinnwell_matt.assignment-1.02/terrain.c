...
void terrain_init(map_t *p, int xCoord, int yCoord) {
  ...
  // make_Map(x, y, xCoord, yCoord, p->t);

}

void make_Map(int x, int y, int t[21][80], int xc, int yc){
// void make_Map(int x, int y, int t[21][80]) {
  //seed randomizer
  srand(time(NULL));
  ...
  //grow the seeds
  //yaseen says t should be 
  growSeeds(t, tallGrassX1, tallGrassY1, tallGrassX2, tallGrassY2, clearingX1, clearingY1, c\
learingX2, clearingY2);
