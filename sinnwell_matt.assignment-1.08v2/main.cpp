...
void movePC(Character* pc, map_t * w, Character * characterTable[21][80], int hikerDistance[21][80], int rivalDistance[21][80], int xChange, int yChange, Character** characterQ) {
  ...
  if (characterTable[moveX][moveY] && characterTable[moveX][moveY]->isBattled == 0 && characterTable[moveX][moveY]->charValue != '@') {
    ...
    // pokemon_move_db move2;
      ...
      // wprintw(pokeWindow, thisPm->identifier);
      ...
      // string movesSizeToString = to_string(movesSize);
      // wprintw(pokeWindow, "The Number oF Mmoves is : ");
      // wprintw(pokeWindow, movesSizeToString.c_str());
      // wprintw(pokeWindow, "\n");

      // //find an IV number
      // int IV = getRandomNumber(15);
      ...
      //   if (stat.stat_id == 1) {
      //     hp = stat.base_stat + IV;
      //   }
      //   if (stat.stat_id == 2) {
      //     attack = stat.base_stat + IV;
      //   }
      //   if (stat.stat_id == 3) {
      //     defense = stat.base_stat + IV;
      //   }
      //   if (stat.stat_id == 6) {
      //     speed = stat.base_stat + IV;
      //   }
      //   if (stat.stat_id == 4) {
      //     specialAttack = stat.base_stat + IV;
      //   }
      //   if (stat.stat_id == 5) {
      //     specialDefense = stat.base_stat + IV;
      //   }
      // }

      // string hpToString = to_string(hp);
      // wprintw(pokeWindow, "The Strength is : ");
      // wprintw(pokeWindow, hpToString.c_str());
      // wprintw(pokeWindow, "\n");

      // string attackToString = to_string(attack);
      // wprintw(pokeWindow, "The Strength is : ");
      // wprintw(pokeWindow, attackToString.c_str());
      // wprintw(pokeWindow, "\n");

      // string defenseToString = to_string(defense);
      // wprintw(pokeWindow, "The Strength is : ");
      // wprintw(pokeWindow, defenseToString.c_str());
      // wprintw(pokeWindow, "\n");
            
      // string speedToString = to_string(speed);
      // wprintw(pokeWindow, "The Strength is : ");
      // wprintw(pokeWindow, speedToString.c_str());
      // wprintw(pokeWindow, "\n");
            
      // string specialAttackToString = to_string(specialAttack);
      // wprintw(pokeWindow, "The Strength is : ");
      // wprintw(pokeWindow, specialAttackToString.c_str());
      // wprintw(pokeWindow, "\n");
            
      // string specialDefenseToString = to_string(specialDefense);
      // wprintw(pokeWindow, "The Strength is : ");
      // wprintw(pokeWindow, specialDefenseToString.c_str());
      // wprintw(pokeWindow, "\n");
